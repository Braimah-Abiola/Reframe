            ...
            {items.map((item) => (
                ...
                >
                    <AnimatePresence mode="popLayout">
                        {hoveredIndex === item.id && (
                            ...
                            >
                                ...
                                <div className="relative z-30 text-[15px] font-medium text-white">
                                    {item.name}
                                </div>
                    ...
                    <Image
                        ...
                        src={item.image}
                        alt={item.name}
                        className="relative !m-0 h-9 w-9 md:h-12 md:w-12 rounded-full border border-input object-cover object-top !p-0 transition duration-500 group-hover:z-30 group-hover:scale-105"
                    />
                </div>
            ))}
        </>
