...
const WhyUs = () => {
    return (
        <section className=" relative flex flex-col">
            ...
            <div className=" px-4 md:px-10 md:py-20">
                <div className=" flex flex-col items-center w-full h-full bg-white rounded-lg md:rounded-xl py-8 md:py-20 px-4 md:px-0">
                    ...
                    <h2 className=" mt-2 font-montserrat font-semibold text-4xl md:text-5xl tracking-tighter text-center capitalize">
                        Why Reframe Labs? We Care <br className=" hidden md:block" /> Like Co-Founders
                    </h2>
