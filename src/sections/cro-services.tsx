...
import { croServices } from "@/constants";
        ...
        <section className=" relative flex flex-col">
            ...
            <div className=" px-4 md:px-10 py-20 md:py-24">
                <div className=" flex flex-col items-center w-full h-full bg-white rounded-xl px-4 md:px-0 pt-12 pb-4 md:pt-20 md:pb-20">
                    ...
                    <h2 className=" hidden md:block mt-2 font-montserrat font-semibold text-5xl tracking-tighter text-center capitalize">
                        Our Conversion Rate <br /> Optimization Services
                    </h2>
                    <h2 className=" md:hidden mt-2 font-montserrat font-semibold text-4xl tracking-tighter text-center capitalize">
                        Our CRO Services
                    </h2>
