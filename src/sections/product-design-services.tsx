    ...
    return (
        <section className=" relative flex flex-col">
            ...
            <div className=" px-4 md:px-10 py-12 md:py-20">
                <div className=" flex flex-col items-center w-full h-full bg-white px-4 md:px-0 rounded-xl pt-12 pb-4 md:pb-20 md:pt-20">
                    <div className=" cursor-pointer rounded-full flex items-center px-2.5 py-1 bg-white border hover:border-primary hover:bg-white hover:shadow-xs">
                        ...
                        <span className=" ml-2 text-sm md:text-base">Design Services</span>
                    </div>
                    <h2 className=" mt-2 font-montserrat font-semibold text-4xl md:text-5xl tracking-tighter text-center capitalize">
                        Our Product <br className=" hidden md:block" /> Design Services
                    </h2>
